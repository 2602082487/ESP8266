...
{
    uint8_t*  _data;          /* buffer数据 */
    uint32_t  _write_pos;     /* buffer写入位置 */
    uint32_t  _read_pos;      /* buffer读取位置 */
    uint32_t  _capacity;      /* buffer容量 */
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t CheckCapacity(Buffer* buf, uint32_t len);
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t ReadByte(EdpPacket* pkg, uint8_t* val);
/* 
 * 函数名:  ReadBytes
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t ReadBytes(EdpPacket* pkg, uint8_t** val, uint32_t count);
/* 
 * 函数名:  ReadUint16
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t ReadUint16(EdpPacket* pkg, uint16_t* val);
/* 
 * 函数名:  ReadUint32
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t ReadUint32(EdpPacket* pkg, uint32_t* val);
/* 
 * 函数名:  ReadStr
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t ReadStr(EdpPacket* pkg, char** val);
/* 
 * 函数名:  ReadRemainlen
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t ReadRemainlen(EdpPacket* pkg, uint32_t* len_val);
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t WriteByte(Buffer* buf, uint8_t byte);
/* 
 * 函数名:  WriteBytes
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t WriteBytes(Buffer* buf, const void* bytes, uint32_t count);
/* 
 * 函数名:  WriteUint16
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t WriteUint16(Buffer* buf, uint16_t val);
/* 
 * 函数名:  WriteUint32
 ...
 *          =0      成功
 */
EDPKIT_DLL int32_t WriteUint32(Buffer* buf, uint32_t val);
/* 
 * 函数名:  WriteStr
 ...
 *          <0      数据错误, 不符合EDP协议
 */
EDPKIT_DLL int32_t IsPkgComplete(RecvBuffer* buf);
 ...
 */
EDPKIT_DLL int32_t UnpackConnectResp(EdpPacket* pkg);
 ...
 */
EDPKIT_DLL int32_t UnpackSavedataInt(SaveDataType type, EdpPacket* pkg,
 ...
 *          <0          解析失败, -1 type类型不合法，其它值见本h文件的错误码
 */
EDPKIT_DLL int32_t UnpackSavedataDouble(SaveDataType type, EdpPacket* pkg,
 ...
 *          <0          解析失败, -1 type类型不合法，其它值见本h文件的错误码
 */
EDPKIT_DLL int32_t UnpackSavedataString(SaveDataType type, EdpPacket* pkg,
 ...
 *          <0          解析失败, 具体失败原因见本h文件的错误码
 */
EDPKIT_DLL int32_t UnpackPingResp(EdpPacket* pkg);
